...
const INCLINE_DUMBBELL_PRESS = {
  ...
  keys: [
    { // lockout, arms long square to the reclined torso
      ...
      joints: { spine: 0, neck: -6, forearmPronR: 90, forearmPronL: 90, shoulderR: 210, shoulderL: 210, shoulderAbdR: 0, shoulderAbdL: 0, elbowR: 0, elbowL: 0, shoulderRotR: 90, shoulderRotL: -90 },
      ik: { ...stand(110, 104) },
    },
    { // halfway, a waypoint not a stop: elbow out toward the feet, bell on its line
      t: 0.5, through: true,
      root: { x: 84, y: 90, rot: -55 },
      joints: { spine: 2, neck: -8, forearmPronR: 90, forearmPronL: 90, shoulderR: 202, shoulderL: 202, shoulderAbdR: 25, shoulderAbdL: 25, elbowR: 0, elbowL: 0, shoulderRotR: 23, shoulderRotL: -23 },
      ik: { ...stand(110, 104) },
    },
    { /* bottom, bells beside the UPPER chest, just below the collarbone, which
      ...
      t: 1,
      root: { x: 84, y: 90, rot: -55 },
      joints: { spine: 2, neck: -8, forearmPronR: 90, forearmPronL: 90, shoulderR: 103, shoulderL: 103, shoulderAbdR: 39, shoulderAbdL: 39, elbowR: 125, elbowL: 125, shoulderRotR: 35, shoulderRotL: -35 },
      ik: { ...stand(110, 104) },
    },
  ],
};
...
const DECLINE_DUMBBELL_PRESS = {
  ...
  keys: [
    { // lockout, bells square to the declined torso
      ...
      joints: { spine: 0, neck: 6, shoulderR: 294, shoulderL: 294, shoulderAbdR: 13, shoulderAbdL: 13, elbowR: 0, elbowL: 0, shoulderRotR: -1, shoulderRotL: 1 },
      ik: { ...pinFeet(112, 58, 108, 62) },
    },
    { // halfway, a waypoint not a stop: elbow out toward the feet, bell on its line
      t: 0.5, through: true,
      root: { x: 78, y: 64, rot: -115 },
      joints: { spine: 2, neck: 8, shoulderR: 205, shoulderL: 205, shoulderAbdR: 47, shoulderAbdL: 47, elbowR: 110, elbowL: 110, shoulderRotR: 13, shoulderRotL: -13 },
      ik: { ...pinFeet(112, 58, 108, 62) },
    },
    { // bottom, bells beside the lower chest
      t: 1,
      root: { x: 78, y: 64, rot: -115 },
      joints: { spine: 2, neck: 8, shoulderR: 186, shoulderL: 186, shoulderAbdR: 40, shoulderAbdL: 40, elbowR: 110, elbowL: 110, shoulderRotR: 41, shoulderRotL: -41 },
      ik: { ...pinFeet(112, 58, 108, 62) },
    },
  ],
};
...
const INCLINE_BARBELL_PRESS = {
  ...
  keys: [
    { // lockout above the upper chest
      t: 0,
      root: { x: 84, y: 90, rot: -55 },
      joints: { spine: 0, neck: -6, shoulderR: 210, shoulderL: 210, shoulderAbdR: 0, shoulderAbdL: 0, elbowR: 0, elbowL: 0, shoulderRotR: 90, shoulderRotL: -90 },
      ik: { ...stand(110, 104) },
    },
    { // halfway, a waypoint not a stop: elbow out toward the feet, bell on its line
      t: 0.5, through: true,
      root: { x: 84, y: 90, rot: -55 },
      joints: { spine: 2, neck: -8, shoulderR: 202, shoulderL: 202, shoulderAbdR: 25, shoulderAbdL: 25, elbowR: 0, elbowL: 0, shoulderRotR: 23, shoulderRotL: -23 },
      ik: { ...stand(110, 104) },
    },
    { // bar down to the collarbone, elbows under the bar
      t: 1,
      root: { x: 84, y: 90, rot: -55 },
      joints: { spine: 2, neck: -8, shoulderR: 103, shoulderL: 103, shoulderAbdR: 39, shoulderAbdL: 39, elbowR: 125, elbowL: 125, shoulderRotR: 35, shoulderRotL: -35 },
      ik: { ...stand(110, 104) },
    },
  ],
};
